...
Prices are set per furniture **category** in `lib/wallet.ts`, so catalog items added later
get a price automatically: painting / chest 10, plant / lamp 15, rug 20, desk 25, bed 30.
...
- `components/InteriorEditor.tsx`: the "Place:" list becomes a shop. Each item shows how
  many you own, or its price. Clicking an item you own places it; clicking one you don't own
