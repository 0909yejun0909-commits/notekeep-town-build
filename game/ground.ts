...
export function buildGround(scene: Phaser.Scene, g: WorldGrid): Ground {
  ...
  const ts = [
    map.addTilesetImage('g1', 'grass-edges', 16, 16, 0, 0, GID_G1),
    map.addTilesetImage('g2', 'grass-2', 16, 16, 0, 0, GID_G[2]),
    map.addTilesetImage('g3', 'grass-3', 16, 16, 0, 0, GID_G[3]),
    map.addTilesetImage('g4', 'grass-4', 16, 16, 0, 0, GID_G[4]),
    map.addTilesetImage('f2', 'fill-grass-2', 16, 16, 0, 0, GID_FILL[2]),
    map.addTilesetImage('f3', 'fill-grass-3', 16, 16, 0, 0, GID_FILL[3]),
    map.addTilesetImage('f4', 'fill-grass-4', 16, 16, 0, 0, GID_FILL[4]),
  ].filter((t): t is Phaser.Tilemaps.Tileset => t !== null);
  const pebbles = map.addTilesetImage('pebbles', 'path-decor', 16, 16, 0, 0, GID_PEBBLE)!;
  const cobble = map.addTilesetImage('cobble', 'cobble-edges', 16, 16, 0, 0, GID_COBBLE)!;
